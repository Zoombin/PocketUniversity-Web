...
class LiangpingSmsSender
{
	...
	public function sendsms($username,$password,$mobiles,$msg)
	{
		...
		$apidata="method=sendSMS&isLongSms=1&username=$username&password=$password&smstype=0&mobile=$mobiles&content=$content";
		//echo $apidata;
		$apiurl = "http://139.159.32.10:8888/servlet/UserServiceAPI";
		//echo $apiurl;
		$ret= $this->request($apiurl,$apidata);
		$ret["body"]=mb_convert_encoding($ret["body"], 'utf-8' ,'gb2312');
		if($ret && strpos('xxx'.$ret["body"],"success")>0)
		{
		  //echo $ret["body"];
