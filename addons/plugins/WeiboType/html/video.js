...
jQuery.extend(weibo.plugin.video, {
	...
	html:function(){
	    return '<dl id="video_input" class="layer_upload_video" style="min-width:160px; padding:20px 10px;"><dt>请输入'+weibo.plugin.video.type+'的视频播放页链接： </dt><dd><input name="publish_type_data" type="text" style="width: 204px;" class="text" value="" /></dd><dd><input type="button" class="btn_b" onclick="weibo.plugin.video.add_video()" value="添加"></dd></dl><div style="display:none" id="video_add_complete">添加完成</div>';
	},
