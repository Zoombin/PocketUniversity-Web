...
//                if(time()>  strtotime('2013-10-10')){
                    $emailset['email_sendtype'] = 'smtp';
                    $emailset['email_host'] = 'smtp.vip.163.com';
                    $emailset['email_port'] = '25';
                    $emailset['email_ssl'] = 0;
                    $emailset['email_sender_name'] = 'PU网站平台';
                    $emailset['email_password'] = 'pupupu';
                    $num = rand(0,5);
                    if($num == 0){
                        $emailset['email_account'] = 'pocketuni@vip.163.com';
                    }else{
                        $emailset['email_account'] = 'pocketuni_'.$num.'@vip.163.com';
                    }
                    $emailset['email_sender_email'] = $emailset['email_account'];
//                }else{
