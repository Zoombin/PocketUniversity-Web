...
class FeedService extends Service {
	...
	public function enumerateType() {
		...
		//return getSubByKey ( $res, 'type' );
            return array('event_active_delaudit','event_audit','event_course_active_audit','event_course_audit','event_course_del','event_course_delaudit','event_del'
,'event_delaudit','event_finishback','event_group_audit','event_group_delaudit','event_group_disband','event_group_init','event_group_nodisband'
,'event_pass','event_reject','group_audit','weibo_follow');
	}
