    ...
    $.fn.placeholder = function(options) {
        ...
        $(this).each(function() {
            ...
            if (params.labelMode) {
                ...
                var abstop=element.position().top;
                var added=element.outerHeight(true)-element.innerHeight();
                if(added>0)
                    abstop+=added;
                else
                    abstop+=2;
                var absleft=element.position().left;
                var addedl=element.outerWidth(true)-element.innerWidth();
                if(addedl>0){
                    absleft+=addedl;
                }else{
                    absleft+=2;
