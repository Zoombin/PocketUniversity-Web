...
function changeSchool(){
    ui.box.load(U('home/Public/newSchool'),{title:'选择学校'});
}
function changePreSchool(url){
    ui.box.load(U('home/Public/newPreSchool')+'&url='+url,{title:'选择学校'});
}
...
// 过滤html，字串检测长度
function tsStripTagsLength(content){
    return getLength(strip_tags(content));
}