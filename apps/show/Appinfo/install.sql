...
CREATE TABLE `ts_show_user_flash` (
  `id` mediumint(5) NOT NULL auto_increment,
  `uid` mediumint(5) NOT NULL default '0',
  `path` varchar(255) NOT NULL DEFAULT '' COMMENT '靓照',
...
VALUES 
    (0,'show','version_number','s:1:"1";','2012-10-29 00:00:00');