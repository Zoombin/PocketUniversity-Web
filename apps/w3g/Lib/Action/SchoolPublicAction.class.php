...
class SchoolPublicAction extends SchoolBaseAction {
    ...
    public function login() {
        ...
        if ($passport->isLogged()) {
            $this->redirect(U('w3g/School/index'));
        }
