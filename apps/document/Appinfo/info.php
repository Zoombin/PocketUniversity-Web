...
return array(
	...
	// 应用图标 [必填]
	'ICON_URL'					=> SITE_URL . '/apps/document/Appinfo/ico_app.png',
	// 应用图标 [必填]
	'LARGE_ICON_URL'			=> SITE_URL . '/apps/document/Appinfo/ico_app_large.png',
	// 版本号 [必填]
	'VERSION_NUMBER'			=> '1',
	// 后台入口 [选填]
	'ADMIN_ENTRY'				=> 'Admin/index',
	// 统计入口 [选填]（格式：Model/method）
	'STATISTICS_ENTRY'			=> 'DocumentStatistics/statistics',
	// 应用的主页 [选填]
	'HOMEPAGE_URL'				=> '',
	// 应用类型
	'CATEGORY'					=> '工具',
	...
	// 最后更新日期
	'LAST_UPDATE_DATE'			=> '2012-08-01',

	// 附加链接名称 [选填]
	'SIDEBAR_TITLE'				=> '上传',
	// 附件链接的入口 [选填]（格式：Action/act）
	'SIDEBAR_ENTRY'				=> 'Upload/index',
	// 附加链接的图标 [选填]
	'SIDEBAR_ICON_URL'			=> '',
