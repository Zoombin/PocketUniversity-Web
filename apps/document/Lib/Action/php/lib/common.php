...
*/
    ...
    function getConvertType($inputFileName){
		$inputExt=getExtension($inputFileName);
		...
		if(in_array($inputFormat,array('text','spreadsheet','presentation')))
		    $canConvert=2;
		elseif(in_array($inputFormat,array('pdf')))
		    $canConvert=1;
		elseif(in_array($inputFormat,array('swf')))
			$canConvert=0;
		else
			$canConvert=-1;
