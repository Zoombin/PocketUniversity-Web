...
class AdminAction extends PubackAction {
    ...
    public function recycle() {
        $list = D('Document')->where('isDel=1')->order('ctime DESC')->findPage();
        $this->assign($list);
        $this->display();
    }
    ...
    public function audit() {
        $audit_list = D('Document')->where('status=0 AND isDel=0 And privacy=1')->order('ctime DESC')->findPage();
    ...
    public function editDocument() {
        ...
        if ($document['schoolid'] != 0) {
            ...
            if (isset($sCat[$sid0]) && $sCat[$sid0]['pid'] == 0) {
                $sid1 = 0;
            } elseif (isset($sCat[$sid0]) && $sCat[$sid0]['pid'] != 0) {
                $sid0 = $sCat[$sid0]['pid'];
            }
        }
