...
return array(
	...
	'router' => array(
		...
		'event/Index/member'		=>	'app/event/member/[id]',
                ...
                'event/Front/index'			=>	'eventf/[id]',
                'event/Front/news'			=>	'eventf/news/[id]',
                'event/Front/newsDetails'		=>	'eventf/newsDetails/[id]',
                'event/Front/player'                    =>	'eventf/player/[id]',
                'event/Front/playerDetails'		=>	'eventf/playerDetails/[id]',
                'event/Front/video'                    =>	'eventf/video/[id]',
                'event/Front/photo'                    =>	'eventf/photo/[id]',
                'event/Front/join'                    =>	'eventf/join/[id]',
                'event/Front/doAddUser'                 =>	'eventf/doAddUser/[id]',
                'event/Front/details'                 =>	'eventf/details/[id]',
                'event/Front/jsonPhoto'                 =>	'eventf/jsonPhoto/[id]',
                'event/Front/vote'                      =>	'eventf/vote/[id]',
		...
		'show/Index/video'		=>	'show/video',
		'show/Index/photo'		=>	'show/photo',
		'show/Index/playFlash'		=>	'show/playFlash',
		'show/News/index'		=>	'show/news',
		'show/News/details'		=>	'show/news/details',
		'show/Player/index'		=>	'show/player',
		'show/Player/details'		=>	'show/player/details',
                // hold
		'hold/Index/index'			=>	'hold',
		'hold/Index/video'		=>	'hold/video',
		'hold/Index/photo'		=>	'hold/photo',
		'hold/Index/playFlash'		=>	'hold/playFlash',
		'hold/News/index'		=>	'hold/news',
		'hold/News/details'		=>	'hold/news/details',
		'hold/Player/index'		=>	'hold/player',
		'hold/Player/details'		=>	'hold/player/details',
                // 图书馆
		'lib/Index/index'			=>	'lib',
	)
);